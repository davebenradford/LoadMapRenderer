 ...
 */
public class LegendEntryPanelClone extends JPanel implements ItemListener, 
    ...
    public LegendEntryPanelClone(MapLayer layer, WhiteboxPluginHost host, Font font, 
    ...
    public LegendEntryPanelClone(String mapTitle, WhiteboxPluginHost host, Font font, 
       int mapNum, int mapAreaNum, int layerNum, boolean isSelected) {
    ...
    public LegendEntryPanelClone(MapArea mapArea, WhiteboxPluginHost host, Font font, 
       int mapNum, int mapAreaNum, int layerNum, boolean isSelected) {
