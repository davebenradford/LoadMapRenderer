...
import loadmaprenderer.WhiteboxGuiClone;
...
public class CartographicToolbar extends JToolBar {
    ...
    public CartographicToolbar(WhiteboxGuiClone host, boolean buttonVisibility) {
        this.host = host;
    ...
    // properties
    public WhiteboxGuiClone getHost() {
        return host;
    }

    public void setHost(WhiteboxGuiClone host) {
        this.host = host;
    }
